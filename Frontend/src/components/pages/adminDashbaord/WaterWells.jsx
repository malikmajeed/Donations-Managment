...
const UserStats = () => {
  const stats = [
    {
      title: 'Total Water Wells Causes',
      value: '60',
      change: '+1.2%',
      changeType: 'positive',
...
const WaterWells = () => {
  ...
  const dropdowns = [
    ...
    },
    {
      ...
      items: [
        ...
        { value: 'solar-well', label: 'Solar Well' },
        { value: 'community-well', label: 'Community Well' },
        { value: 'rehabilitation', label: 'Rehabilitation' },
        { value: 'water-filtration', label: 'Water Filtration' },
        { value: 'emergency', label: 'Emergency Water Supply' }
      ]
    },
    {
      name: 'urgency',
  ...
  useEffect(() => {
    const fetchCauses = async () => {
      try {
        ...
        setCauses(res.data.causes.filter(cause => cause.type === 'waterWells'));
      } catch (err) {
  ...
  if (loading) return <div className="text-center py-8 text-gray-600">Loading water wells causes...</div>;
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm grid grid-cols-1 md:grid-cols-10 gap-4 items-center text-left">
        <div className="col-span-1 md:col-span-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4 md:mb-0">Water Wells Causes</h1>
          <p className="text-gray-600 text-lg leading-relaxed">
            Building and maintaining water wells to provide clean drinking water to communities. Explore, manage, and track water well causes here.
          </p>
        </div>
              ...
              <tr>
                <td colSpan={6} className="py-16 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <span className="text-2xl font-semibold text-gray-500">No Water Wells Causes Found</span>
      ...
      {showAddCause && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <AddCause type="waterWells" onClose={() => setShowAddCause(false)} />
        </div>
      )}
    </div>
  );
