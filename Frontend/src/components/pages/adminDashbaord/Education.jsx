  ...
  useEffect(() => {
    const fetchCauses = async () => {
      try {
        ...
        setCauses(res.data.causes.filter(cause => cause.type === `${CauseType}`));
      } catch (err) {
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm grid grid-cols-1 md:grid-cols-10 gap-4 items-center text-left">
        <div className="col-span-1 md:col-span-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4 md:mb-0">Education Causes</h1>
          <p className="text-gray-600 text-lg leading-relaxed">
            Support educational initiatives and learning opportunities for communities in need. Explore, manage, and track education-related causes here.
          </p>
        </div>
              ...
              <tr>
                <td colSpan={6} className="py-16 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <span className="text-2xl font-semibold text-gray-500">No Education Causes Found</span>
