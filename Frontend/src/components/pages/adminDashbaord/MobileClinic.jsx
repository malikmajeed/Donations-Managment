...
const UserStats = () => {
  const stats = [
    {
      title: 'Total Mobile Clinic Causes',
      value: '90',
      change: '+1.2%',
      changeType: 'positive',
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm grid grid-cols-1 md:grid-cols-10 gap-4 items-center text-left">
        <div className="col-span-1 md:col-span-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4 md:mb-0">Mobile Clinic Causes</h1>
          <p className="text-gray-600 text-lg leading-relaxed">
            Healthcare services delivered through mobile clinics to reach remote and underserved areas. Explore, manage, and track mobile clinic causes here.
          </p>
        </div>
              ...
              <tr>
                <td colSpan={6} className="py-16 text-center">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <span className="text-2xl font-semibold text-gray-500">No Mobile Clinic Causes Found</span>
